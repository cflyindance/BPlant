...
const reasons = {
  ...
  "guest-menu-structure":
    "eMenu 服务设置·菜单：组类树、导航位、瀑布流与价格展示等结构项；展示 SSOT（515/516/524/528），去重见 §3.12。",
  "guest-menu-scenarios":
    "C 端自助餐/场景菜单编排：品类设置与分类设置（655–661），统一在前厅按运营场景配置。",
  "guest-menu-global":
    "全店默认菜单组、点单模式、首页入口与列表版式（含 600 纯展示、604 Pro）；532/612 为 **品牌露出显隐**（eMenu）；542 为 Kiosk 本地菜单标签源开关；Kiosk/eMenu 封面·门店 Logo **维护**在素材中心（555/556 等），见 §3.15。",
  ...
  "guest-order-rules":
    "食客端/Kiosk 送厨、场景下单（品类/火锅 571–575/573/577–580）、场景计价（443）、轮次规则；不含纯展示模式 600；593 在商品管理维护。",
  "guest-notes-fees":
...
const assignMap = {
  ...
  "pos-order-cart": [132, 133, 135, 136, 137, 121, 122, 178],
  ...
  "guest-menu-global": [532, 542, 599, 601, 602, 604, 606, 607, 608, 611, 600, 612, 645],
  "guest-menu-cart": [616, 617, 618],
  "guest-facing-locale": [652, 653],
  "guest-order-rules": [
    91, 443, 502, 567, 571, 572, 574, 575, 569, 570, 573, 577, 578, 579, 580, 581, 597, 598,
  ],
...
push(
  ...
  "",
  "> 文档版本：v1.17（已确认）  ",
  "> 数据范围：前厅设置 catalog **138** 条（v1.17 自订单迁入 POS 结账入口 221/248；跨 hub 见 §3.2–§3.19）  ",
